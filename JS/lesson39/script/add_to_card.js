    ...
    creat_li.innerHTML = '<div class="bag__img">\
                                ...
                                <div class="bag__info">\
                                    ...
                                    <div class="info__price">\
                                        <span id="summa1">' + price[0].innerText + '</span>\
                                    </div>\
                                    <div class="trash">\
...
// сумма 
function sum() {
    var sumPrice = document.querySelectorAll("#summa1");
    let sum = 0;
    for (var i = 0; i < sumPrice.length; i++) {
        sum += parseFloat(sumPrice[i].innerHTML);

    }
    document.getElementById("total_sum").innerText = sum + ' $';
